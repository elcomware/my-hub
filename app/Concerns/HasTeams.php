...
trait HasTeams
{
    ...
    public function toTeamPermissions(Team $team): TeamPermissions
    {
        ...
        return new TeamPermissions(
            ...
            canManageApps: $role?->hasPermission(TeamPermission::ManageApps) ?? false,
            canManageAnnouncements: $role?->hasPermission(TeamPermission::ManageAnnouncements) ?? false,
            canManageBranding: $role?->hasPermission(TeamPermission::ManageBranding) ?? false,
        );
    }
