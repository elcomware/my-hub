...
class TeamPolicy
{
    ...
    /**
     * Determine whether the user can manage the team's apps.
     */
    public function manageApps(User $user, Team $team): bool
    {
        return $user->hasTeamPermission($team, TeamPermission::ManageApps);
    }

    /**
     * Determine whether the user can manage the team's announcements.
     */
    public function manageAnnouncements(User $user, Team $team): bool
    {
        return $user->hasTeamPermission($team, TeamPermission::ManageAnnouncements);
    }

    /**
     * Determine whether the user can manage the team's branding.
     */
    public function manageBranding(User $user, Team $team): bool
    {
        return $user->hasTeamPermission($team, TeamPermission::ManageBranding);
    }
